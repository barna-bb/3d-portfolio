...
export const projects = [
    {
        ...
        description: 'Developed a user-friendly Web3 e-commerce website, providing a seamless shopping experience with enhanced security features.',
    ...
    },
    {
        ...
        name: 'AI Chatbot',
        description: 'Created a <strong>Rust</strong>-based AI chatbot, offering intuitive interaction and streamlined communication capabilities.',
    ...
    },
    {
        ...
        name: 'Gym Tracking Application',
        description: 'In progress: Crafting a groundbreaking gym tracking application using <strong>React Native</strong>, featuring pioneering functionalities yet to be explored in the fitness tech landscape. Stay tuned for updates on this exciting project!',
    ...
    },
    {
        ...
        description: 'Collaborated on a group project during university to develop a mentoring platform tailored for Deutsche Bank, fostering professional growth and mentorship opportunities within the organization.',
        link: '#',
        renderButton: false,
    }
];